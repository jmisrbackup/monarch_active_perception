#include <active_perception_controller/active_perception_interface.h>
#include <pluginlib/class_list_macros.h>
#include <active_perception_controller/ActivePerceptionPlan.h>

PLUGINLIB_EXPORT_CLASS(active_perception_interface::ActivePerceptionInterface, nav_core::BaseGlobalPlanner);

using namespace active_perception_interface;

ActivePerceptionInterface::
ActivePerceptionInterface() :
nh_(),
motion_planner_srv_(nh_.serviceClient<active_perception_controller::ActivePerceptionPlan>("plan"))
{}
